    ...
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <motion.div
          ...
          className="absolute top-0 left-0 w-[500px] h-[500px] bg-gradient-to-br from-green-600 via-emerald-600 to-transparent rounded-full blur-3xl opacity-25"
        />
        <motion.div
          animate={{ opacity: [0.3, 0.5, 0.3] }}
          transition={{ duration: 8, repeat: Infinity, ease: 'easeInOut' }}
          className="absolute inset-0 bg-[linear-gradient(rgba(52,211,153,0.04)_1px,transparent_1px),linear-gradient(90deg,rgba(52,211,153,0.04)_1px,transparent_1px)] bg-[length:50px_50px]"
        />
      </div>
      ...
      <div className="relative z-10 flex flex-col md:flex-row h-screen gap-0">
        ...
        <motion.div
          ...
          className={`fixed md:static top-0 left-0 h-screen w-64 sm:w-72 bg-gradient-to-b from-black via-gray-950 to-black backdrop-blur-2xl border-r border-green-500/5 flex flex-col shadow-2xl z-40 ${
        ...
        >
          <motion.div
            ...
            className="px-6 sm:px-8 py-6 sm:py-8 border-b border-green-500/5"
          >
            <motion.div
              animate={{ scale: [1, 1.08, 1] }}
              transition={{ duration: 2.5, repeat: Infinity, ease: 'easeInOut' }}
              className="text-2xl sm:text-3xl font-black bg-gradient-to-r from-green-400 to-emerald-500 bg-clip-text text-transparent tracking-tight"
            >
              HMS
            </motion.div>
            <p className="text-xs text-green-400/50 mt-2 font-medium tracking-widest">ADMIN</p>
          </motion.div>
                ...
                >
                  {activeTab === item.id && (
                    <>
                      <motion.div
                        layoutId="activeBg"
                        className="absolute inset-0 bg-gradient-to-r from-green-600/20 via-emerald-600/20 to-teal-600/10 rounded-xl"
                        transition={{ type: 'spring', stiffness: 380, damping: 40 }}
                      />
                      <motion.div
                        layoutId="activeBorder"
                        className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-green-400 to-emerald-600 rounded-r"
                        transition={{ type: 'spring', stiffness: 380, damping: 40 }}
                      />
                    </>
                  )}
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.6, duration: 0.6 }} className="px-6 sm:px-8 py-4 sm:py-6 border-t border-green-500/5">
            <motion.button
        ...
        <div className="flex-1 flex flex-col w-full md:pb-0 pb-20">
          ...
          <motion.div
            ...
            transition={{ duration: 0.7, ease: 'easeOut', type: 'spring', stiffness: 100 }}
            className="bg-gradient-to-r from-black via-gray-950/50 to-black backdrop-blur-2xl border-b border-green-500/5 px-4 sm:px-6 lg:px-8 py-4 sm:py-6 flex justify-between items-center"
          >
            <h1 className="text-xl sm:text-2xl lg:text-4xl font-black bg-gradient-to-r from-green-400 to-emerald-500 bg-clip-text text-transparent truncate">Admin Dashboard</h1>
            <div className="flex items-center gap-2 sm:gap-4">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                disabled={loading}
                className="hidden sm:block px-3 sm:px-4 py-2 bg-green-500/20 border border-green-500/40 rounded-lg text-green-400 font-semibold hover:bg-green-500/30 transition-all duration-300 disabled:opacity-50 text-sm"
              >
          ...
          {/* Content */}
          <div className={`flex-1 overflow-auto ${activeTab === 'security' ? '' : 'p-4 sm:p-6 lg:p-8'} bg-gradient-to-b from-black to-gray-950`}>
            <AnimatePresence mode="wait">
              {error && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0, y: -20 }}
                  className="mb-4 sm:mb-6 p-3 sm:p-4 bg-red-500/20 border border-red-500/40 rounded-lg text-red-400 text-xs sm:text-sm"
                >
                  ⚠️ {error}
                </motion.div>
              )}
                ...
                <>
                    ...
                    <motion.div key="dashboard" variants={pageVariants} initial="initial" animate="animate" exit="exit">
                      <motion.div variants={containerVariants} initial="hidden" animate="visible">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8 sm:mb-12">
                          {[
                            { title: 'Total Patients', value: stats.total_patients, icon: '👥', color: 'from-cyan-500 to-blue-600' },
                            { title: 'Total Doctors', value: stats.total_doctors, icon: '👨‍⚕️', color: 'from-purple-500 to-pink-600' },
                            { title: 'Total Appointments', value: stats.total_appointments, icon: '📅', color: 'from-orange-500 to-red-600' },
                            { title: 'Total Revenue', value: `$${stats.total_revenue.toFixed(2)}`, icon: '💰', color: 'from-yellow-500 to-amber-600' },
                          ].map((stat, idx) => (
                            <motion.div key={idx} custom={idx} variants={cardVariants} className="relative p-4 sm:p-8">
                              <div className="absolute -inset-1 bg-gradient-to-r from-green-600/20 via-emerald-600/20 to-teal-600/20 rounded-2xl opacity-0 hover:opacity-100 blur-2xl transition-opacity duration-300" />
                              <div className="relative bg-gradient-to-br from-gray-900/60 to-gray-950/60 backdrop-blur-xl border border-green-500/10 rounded-2xl p-4 sm:p-8 overflow-hidden">
                        ...
                        <motion.div custom={4} variants={cardVariants} className="relative p-4 sm:p-8 mb-8 sm:mb-12">
                          <div className="absolute -inset-1 bg-gradient-to-r from-green-600/20 via-emerald-600/20 to-teal-600/20 rounded-2xl opacity-0 hover:opacity-100 blur-2xl transition-opacity duration-300" />
                          <div className="relative bg-gradient-to-br from-gray-900/60 to-gray-950/60 backdrop-blur-xl border border-green-500/10 rounded-2xl p-4 sm:p-8">
                            <h3 className="text-lg sm:text-xl font-bold mb-4 sm:mb-6 text-green-400">Appointment Status Breakdown</h3>
                            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 sm:gap-4">
                              {Object.entries(stats.status_breakdown || {}).map(([status, count], idx) => (
                                <motion.div
                                  ...
                                  className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-green-500/20"
                                >
                                  <div className="text-xl sm:text-2xl font-bold text-green-400">{count}</div>
                    ...
                    <motion.div key="activity" variants={pageVariants} initial="initial" animate="animate" exit="exit">
                      <motion.div variants={containerVariants} initial="hidden" animate="visible">
                        ...
                        <motion.div custom={0} variants={cardVariants} className="relative p-4 sm:p-8 mb-8 sm:mb-12">
                          <div className="absolute -inset-1 bg-gradient-to-r from-green-600/20 via-emerald-600/20 to-teal-600/20 rounded-2xl opacity-0 hover:opacity-100 blur-2xl transition-opacity duration-300" />
                          <div className="relative bg-gradient-to-br from-gray-900/60 to-gray-950/60 backdrop-blur-xl border border-green-500/10 rounded-2xl p-4 sm:p-8">
                            <h3 className="text-lg sm:text-xl font-bold mb-4 sm:mb-6 text-green-400">Recent Purchases</h3>
                              ...
                              <div className="space-y-2 sm:space-y-3">
                                {stats.recent_bills.map((bill, idx) => (
                                  <motion.div
                                    ...
                                    className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-green-500/20 hover:border-green-500/40 transition-all"
                                  >
                                    ...
                                    <p className="text-base sm:text-lg font-bold text-yellow-400">${bill.total_amount.toFixed(2)}</p>
                                  </motion.div>
                                ))}
                              </div>
                            ) : (
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-8 sm:mb-12">
                          ...
                          <motion.div custom={1} variants={cardVariants} className="relative p-4 sm:p-8">
                            <div className="absolute -inset-1 bg-gradient-to-r from-green-600/20 via-emerald-600/20 to-teal-600/20 rounded-2xl opacity-0 hover:opacity-100 blur-2xl transition-opacity duration-300" />
                            <div className="relative bg-gradient-to-br from-gray-900/60 to-gray-950/60 backdrop-blur-xl border border-green-500/10 rounded-2xl p-4 sm:p-8 min-h-[250px] sm:min-h-[300px]">
                              <h3 className="text-base sm:text-xl font-bold mb-4 sm:mb-6 text-green-400">Appointments Over Time</h3>
                              {stats.daily_appointments && stats.daily_appointments.length > 0 ? (
                                <ResponsiveContainer width="100%" height={200}>
                                  <LineChart data={stats.daily_appointments} margin={{ top: 5, right: 10, left: -30, bottom: 5 }}>
                                    ...
                                    <Tooltip 
                                      contentStyle={{ backgroundColor: 'rgba(31, 41, 55, 0.9)', border: '1px solid rgba(52, 211, 153, 0.3)', borderRadius: '8px' }}
                          ...
                          <motion.div custom={2} variants={cardVariants} className="relative p-4 sm:p-8">
                            <div className="absolute -inset-1 bg-gradient-to-r from-green-600/20 via-emerald-600/20 to-teal-600/20 rounded-2xl opacity-0 hover:opacity-100 blur-2xl transition-opacity duration-300" />
                            <div className="relative bg-gradient-to-br from-gray-900/60 to-gray-950/60 backdrop-blur-xl border border-green-500/10 rounded-2xl p-4 sm:p-8 min-h-[250px] sm:min-h-[300px]">
                              <h3 className="text-base sm:text-xl font-bold mb-4 sm:mb-6 text-green-400">Revenue Over Time</h3>
                  ...
                  {activeTab === 'recent' && (
                    <motion.div key="recent" variants={pageVariants} initial="initial" animate="animate" exit="exit">
                      <h2 className="text-lg sm:text-2xl font-bold mb-4 sm:mb-6 text-green-400">Recent Bookings</h2>
                      {stats.recent_bookings && stats.recent_bookings.length > 0 ? (
                        <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-3 sm:space-y-4">
                          {stats.recent_bookings.map((booking, idx) => (
                            ...
                            >
                              <div className="absolute -inset-1 bg-gradient-to-r from-green-600/20 via-emerald-600/20 to-teal-600/20 rounded-2xl opacity-0 hover:opacity-100 blur-2xl transition-opacity duration-300" />
                              <div className="relative bg-gradient-to-br from-gray-900/60 to-gray-950/60 backdrop-blur-xl border border-green-500/10 rounded-2xl p-4 sm:p-6">
      ...
      <div className="fixed bottom-0 left-0 right-0 md:hidden bg-gradient-to-t from-black via-gray-950 to-transparent border-t border-green-500/5 backdrop-blur-2xl">
          ...
          {navItems.map((item) => (
            <motion.button
              ...
              className={`flex flex-col items-center space-y-1 p-2 rounded-lg transition-all duration-300 ${
                activeTab === item.id ? 'text-green-400 bg-green-500/10' : 'text-gray-400 hover:text-gray-200'
              }`}
            >
